...
<template>
  <section class="fresh-take">
    <Motion as="div" v-bind="fadeUp" class="fresh-take__banner" :style="{ backgroundImage: `url(${bannerImg})` }">
      <div class="fresh-take__content">
...
.fresh-take__content {
  position: absolute;
  left: calc(100vw * 68 / 1920);
  right: calc(100vw * 68 / 1920);
